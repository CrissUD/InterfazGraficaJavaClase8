...
public class LoginTemplate extends JFrame {
    ...
    public void crearObjetosDecoradores(){
        ...
        iFondo = new ImageIcon("Clase8/resources/img/fondo.png");
        iLogo = new ImageIcon("Clase8/resources/img/logo.png");
        iUsuario = new ImageIcon("Clase8/resources/img/usuario.png");
        iClave = new ImageIcon("Clase8/resources/img/clave.png");
        iPunto = new ImageIcon("Clase8/resources/img/punto.png");
        iFacebook = new ImageIcon("Clase8/resources/img/facebook.png");
        iTwitter = new ImageIcon("Clase8/resources/img/twitter.png");
        iYoutube = new ImageIcon("Clase8/resources/img/youtube.png");
        iSvg = new ImageIcon("Clase8/resources/img/imagen.png");
    }
